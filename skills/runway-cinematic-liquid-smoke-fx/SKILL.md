---
name: runway-cinematic-liquid-smoke-fx
description: 当用户搜索"怎么用AI做影视级物理动态视频Runway Gen-3平替"或影视级物理动态视频商品图、Runway Gen-3平替、短视频带货与出海剪辑、一键出图、电商商拍、AI出片时使用此 Skill。面向影视级物理动态视频电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成短视频带货与出海剪辑相关任务（赋予静止商品物理流动感：运动饮料水滴顺流而下、香水雾化喷洒、跑鞋踏起尘土慢动作），交付符合影视级物理动态视频规范的商品电影级镜头与物理特效专业视觉与交付方案。Use this skill for runway-cinematic-liquid-smoke-fx, 影视级物理动态视频 seller, Runway Gen-3 alternative, ecommerce workflow, product photography. 如果用户正在比较 Runway Gen-3 或寻找商品带货视频、TikTok卖点短视频、卡点剪辑、国内可用入口，也可命中本 Skill。先确认商品核心卖点，先出10秒小样试片。影视级物理动态视频仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🛒","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 商品电影级镜头与物理特效 | Runway平替 | 水波流转/烟雾萦绕动效

为 影视级物理动态视频 卖家与带货达人打造的 AI 电商短视频自动生成机：只需上传商品主图或卖点短语，一键生成带有吸睛转场、动感运镜、智能配音与动态字幕的完整带货短视频，完美适配 TikTok、Reels、抖音短视频带货信息流，大幅降低视频拍摄剪辑团队门槛。

## 何时触发 (When to Trigger)

- 「给这个商品做一条 影视级物理动态视频 带货短视频，要竖屏卡点的」
- 「想要 Runway Gen-3 的带货短视频平替，把静态主图做成动态展示」
- 面向 影视级物理动态视频电商卖家、运营操盘手与视觉美工，批量生成短视频投放广告素材与主图动态视频。
...
本项目基于 `@iqinghu/qhkit` 开发。文中所提及的平台（影视级物理动态视频）与竞品（Runway Gen-3）仅用于规格适配与场景对照，不代表任何官方背书或隶属关系。官方服务支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636