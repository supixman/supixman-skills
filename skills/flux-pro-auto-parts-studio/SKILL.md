---
name: flux-pro-auto-parts-studio
description: 当用户搜索"怎么用AI做全球通用全域电商商拍"或全球通用商品图、Midjourney平替、全域电商商拍、一键出片、商业置景、出海商拍时使用此 Skill。面向全球通用电商卖家、账号C: 极客开发者 / 开源自动化号与视觉美工，帮助通过 AI 自动化完成全域电商商拍，提效降本，交付符合全球通用规范的商业级交付成品（图片/视频/文案）。Use this skill for flux-pro-auto-parts-studio, 全球通用 seller, Midjourney alternative, ecommerce ai workflow, ai product photography. 如果用户正在比较 Midjourney 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。全球通用仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 汽摩重型配件与改装件AI商业置景渲染器 | Midjourney平替 | Flux.1商业渲染
