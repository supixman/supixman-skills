---
name: shopee-sea-picwish-batch-sku-cutout
description: 当用户搜索"怎么用AI做Shopee/Lazada佐糖平替"或Shopee/Lazada商品图、佐糖平替、Shopee东南亚运营专精、一键出图、电商商拍、AI出片时使用此 Skill。面向Shopee/Lazada电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成Shopee东南亚运营专精相关任务（支持成百上千款SKU批量导入，自动化流水线去除杂乱底色，按Shopee东南亚尺寸标准统一导出，专为东南亚多店卖家打造，零门槛批量交付。），交付符合Shopee/Lazada规范的Shopee东南亚千张SKU批量抠图换底专业交付套件。Use this skill for shopee-sea-picwish-batch-sku-cutout, Shopee/Lazada seller, 佐糖 PicWish alternative, ecommerce workflow, product photography. 如果用户正在比较 佐糖 PicWish 或寻找单图换色、SKU批量出图、免重拍换色、国内可用入口，也可命中本 Skill。先确认版型与印花保护需求，先出单色小样。Shopee/Lazada仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🌈","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# Shopee东南亚海量SKU批量抠图换底机 | 佐糖平替 | 秒级批处理自动化
...
- 「为 Shopee/Lazada 店铺补齐多 SKU 变体轮播图，免去打样重新拍照成本」
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化方案。文中所提及的平台名称（Shopee/Lazada）及对标工具（佐糖 PicWish）仅用于规格参考与功能描述，不代表官方合作或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636