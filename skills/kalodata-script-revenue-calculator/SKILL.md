---
name: kalodata-script-revenue-calculator
description: 当用户搜索"怎么用AI做TikTok ShopKalodata平替"或TikTok Shop商品图、Kalodata平替、跨境选品分析与数据截流、一键出图、电商商拍、AI出片时使用此 Skill。面向TikTok Shop电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成跨境选品分析与数据截流相关任务（深度测算竞品单条短视频GMV产出与带货佣金率，提取前3秒黄金文案Hook），交付符合TikTok Shop规范的带货短视频带货金额与脚本拆解专业视觉与交付方案。Use this skill for kalodata-script-revenue-calculator, TikTok Shop seller, Kalodata alternative, ecommerce workflow, product photography. 如果用户正在比较 Kalodata 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。TikTok Shop仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 带货短视频带货金额与脚本拆解 | Kalodata平替 | 单条视频产出ROI分析
...
- 「想要 Kalodata 的平替效果，把白底图转成生活方式场景图」
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（TikTok Shop）及竞品商标（Kalodata）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636