---
name: feigua-shortvideo-monitor-engine
description: 当用户搜索"怎么用AI做全电商平台通用飞瓜平替"或全电商平台通用商品图、飞瓜平替、社媒数据与内容运营、一键出图、电商商拍、AI出片时使用此 Skill。面向全电商平台通用电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成社媒数据与内容运营相关任务（自动化每日抓取短视频播放互动全维转化数据），交付符合全电商平台通用规范的短视频数据引擎专业级素材/分析结果。Use this skill for feigua-shortvideo-monitor-engine, 全电商平台通用 seller, 飞瓜数据 / 蝉妈妈 alternative, ecommerce workflow, product photography. 如果用户正在比较 飞瓜数据 / 蝉妈妈 或寻找商品带货视频、TikTok卖点短视频、卡点剪辑、国内可用入口，也可命中本 Skill。先确认商品核心卖点，先出10秒小样试片。全电商平台通用仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🛒","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 短视频数据引擎 | 飞瓜平替 | 自动化每日抓取短视频播放互动全维转化数据
...
- 「想要 飞瓜数据 / 蝉妈妈 的带货短视频平替，把静态主图做成动态展示」
...
本项目基于 `@iqinghu/qhkit` 开发。文中所提及的平台（全电商平台通用）与竞品（飞瓜数据 / 蝉妈妈）仅用于规格适配与场景对照，不代表任何官方背书或隶属关系。官方服务支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636