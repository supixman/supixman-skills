---
name: temu-host-captions-eye-contact-subtitles
description: 当用户搜索"怎么用AI做TEMU全托管/半托管Captions平替"或TEMU全托管/半托管商品图、Captions平替、TEMU跨境运营专精、一键出图、电商商拍、AI出片时使用此 Skill。面向TEMU全托管/半托管电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成TEMU跨境运营专精相关任务（自动修正主播自拍时的漂移眼神，生成专为TEMU跨境信息流打造的动态加粗弹幕字幕，专为TEMU工厂与供货商打造，零门槛批量交付。），交付符合TEMU全托管/半托管规范的TEMU跨境口播眼神校正与高留存字幕专业交付套件。Use this skill for temu-host-captions-eye-contact-subtitles, TEMU全托管/半托管 seller, Captions alternative, ecommerce workflow, product photography. 如果用户正在比较 Captions 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。TEMU全托管/半托管仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# TEMU跨境口播视线矫正与高亮字幕 | Captions平替 | 完播率提升利器
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（TEMU全托管/半托管）及竞品商标（Captions）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636