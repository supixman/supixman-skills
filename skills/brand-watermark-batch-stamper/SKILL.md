---
name: brand-watermark-batch-stamper
description: 当用户搜索"怎么用AI做全电商平台通用加水印平替"或全电商平台通用商品图、加水印平替、电商图像生成与精修、一键出图、电商商拍、AI出片时使用此 Skill。面向全电商平台通用电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成电商图像生成与精修相关任务（批量添加品牌Logo版权保护水印，提升辨识度），交付符合全电商平台通用规范的AI图片加水印专业级素材/分析结果。Use this skill for brand-watermark-batch-stamper, 全电商平台通用 seller, 批量水印工具 alternative, ecommerce workflow, product photography. 如果用户正在比较 批量水印工具 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。全电商平台通用仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# AI图片加水印 | 加水印平替 | 批量添加品牌Logo版权保护水印
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（全电商平台通用）及竞品商标（批量水印工具）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636