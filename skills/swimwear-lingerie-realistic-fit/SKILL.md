---
name: swimwear-lingerie-realistic-fit
description: 当用户搜索"怎么用AI做内衣泳装垂类唯象 WeShop平替"或内衣泳装垂类商品图、唯象 WeShop平替、跨境服饰视觉与试衣、一键出图、电商商拍、AI出片时使用此 Skill。面向内衣泳装垂类电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成跨境服饰视觉与试衣相关任务（精准控制贴身衣物版型，通过亚马逊/TikTok合规性图像审核，杜绝违规封图风险），交付符合内衣泳装垂类规范的泳装内衣高私密合规试穿专业视觉与交付方案。Use this skill for swimwear-lingerie-realistic-fit, 内衣泳装垂类 seller, 唯象 WeShop alternative, ecommerce workflow, product photography. 如果用户正在比较 唯象 WeShop 或寻找假人台穿模、外模试穿、真人模特换脸、国内可用入口，也可命中本 Skill。先核对版型完整度，先出小样；未经确认不批量出全套图。内衣泳装垂类仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"👗","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 泳装内衣高私密合规试穿 | WeShop平替 | 防平台擦边判定合规出图
...
- 面向 内衣泳装垂类电商卖家、运营操盘手与视觉美工，制作服装 Listing 多角度上身主图与详情页画册。
...
本项目基于 `@iqinghu/qhkit` 构建。提及的平台（内衣泳装垂类）与对标工具（唯象 WeShop）仅用于应用场景说明，不代表官方合作或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636