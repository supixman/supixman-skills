---
name: kling-3-sales-video-engine
description: 当用户搜索"怎么用AI做全电商平台通用可灵3.0商业平替"或全电商平台通用商品图、可灵3.0商业平替、主流AI音画模型专项、一键出图、电商商拍、AI出片时使用此 Skill。面向全电商平台通用电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成主流AI音画模型专项相关任务（长镜头多图参考与商品主体一致性带货视频），交付符合全电商平台通用规范的可灵 Kling 3.0 电商带货视频专业级素材/分析结果。Use this skill for kling-3-sales-video-engine, 全电商平台通用 seller, 可灵 Kling 3.0 alternative, ecommerce workflow, product photography. 如果用户正在比较 可灵 Kling 3.0 或寻找商品带货视频、TikTok卖点短视频、卡点剪辑、国内可用入口，也可命中本 Skill。先确认商品核心卖点，先出10秒小样试片。全电商平台通用仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🛒","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 可灵 Kling 3.0 电商带货视频 | 可灵3.0商业平替 | 长镜头多图参考与商品主体一致性带货视频
...
- 「想要 可灵 Kling 3.0 的带货短视频平替，把静态主图做成动态展示」
...
本项目基于 `@iqinghu/qhkit` 开发。文中所提及的平台（全电商平台通用）与竞品（可灵 Kling 3.0）仅用于规格适配与场景对照，不代表任何官方背书或隶属关系。官方服务支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636