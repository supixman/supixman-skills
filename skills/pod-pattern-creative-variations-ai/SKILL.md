---
name: pod-pattern-creative-variations-ai
description: 当用户搜索"怎么用AI做Etsy / Shopify / Amazon图案裂变平替"或Etsy / Shopify / Amazon商品图、图案裂变平替、POD柔性定制设计、一键出图、电商商拍、AI出片时使用此 Skill。面向Etsy / Shopify / Amazon电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成POD柔性定制设计相关任务（基于单张印花裂变出丰富颜色、排版与风格），交付符合Etsy / Shopify / Amazon规范的电商印花裂变专业级素材/分析结果。Use this skill for pod-pattern-creative-variations-ai, Etsy / Shopify / Amazon seller, 图案裂变工具 alternative, ecommerce workflow, product photography. 如果用户正在比较 图案裂变工具 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。Etsy / Shopify / Amazon仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 电商印花裂变 | 图案裂变平替 | 基于单张印花裂变出丰富颜色、排版与风格
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（Etsy / Shopify / Amazon）及竞品商标（图案裂变工具）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636