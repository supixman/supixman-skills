---
name: valentines-romantic-gift-stage
description: 当用户搜索"怎么用AI做情人节礼品营销礼品营销工坊平替"或情人节礼品营销商品图、礼品营销工坊平替、节点大促与主题商拍、一键出图、电商商拍、AI出片时使用此 Skill。面向情人节礼品营销电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成节点大促与主题商拍相关任务（专为首饰、腕表、香水、巧克力定制的高端浪漫送礼场景，主打七夕与情人节礼品季），交付符合情人节礼品营销规范的情人节浪漫送礼高级粉调置景专业视觉与交付方案。Use this skill for valentines-romantic-gift-stage, 情人节礼品营销 seller, 礼品营销工坊 alternative, ecommerce workflow, product photography. 如果用户正在比较 礼品营销工坊 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。情人节礼品营销仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 情人节浪漫送礼高级粉调置景 | 礼品类目爆品 | 丝绒玫瑰烛光柔美光影

为情人节礼品营销卖家与跨境电商打造的 AI 商业场景置景工具：基于「产品原图 + 场景指令」，在保持商品主体、商标与真实结构不变的前提下，自动生成影棚柔光、现代家居、自然户外等商业广告场景，无需实体摄影棚与高昂置景费。

## 何时触发 (When to Trigger)

- 「给这张情人节礼品营销商品图换个高端背景」「把产品放到大理石台面/生活场景中」
- 「想要 礼品营销工坊 的平替效果，把白底图转成生活方式场景图」
- 面向 情人节礼品营销电商卖家、运营操盘手与视觉美工，批量为 SKU 丰富场景图、轮播图与 A+ 详情图。
...
- **能做什么 (Capabilities)**：
  ...
  - 交付物严格符合 情人节礼品营销 移动端及 PC 端详情展示标准。
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（情人节礼品营销）及竞品商标（礼品营销工坊）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636