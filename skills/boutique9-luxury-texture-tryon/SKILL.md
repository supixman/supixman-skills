---
name: boutique9-luxury-texture-tryon
description: 当用户搜索"怎么用AI做高端奢品礼服Boutique9平替"或高端奢品礼服商品图、Boutique9平替、跨境服饰视觉与试衣、一键出图、电商商拍、AI出片时使用此 Skill。面向高端奢品礼服电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成跨境服饰视觉与试衣相关任务（针对婚纱、礼服、高端蕾丝与珠宝，真实还原布料反光透气感与立体刺绣走线），交付符合高端奢品礼服规范的奢品礼服高保真质感上身专业视觉与交付方案。Use this skill for boutique9-luxury-texture-tryon, 高端奢品礼服 seller, Boutique9 alternative, ecommerce workflow, product photography. 如果用户正在比较 Boutique9 或寻找假人台穿模、外模试穿、真人模特换脸、国内可用入口，也可命中本 Skill。先核对版型完整度，先出小样；未经确认不批量出全套图。高端奢品礼服仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"👗","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 奢品礼服高保真质感上身 | Boutique9平替 | 蕾丝刺绣真实光影试戴
...
- 「想要 Boutique9 的平替，需要生成不同国家肤色模特的上身效果」
- 面向 高端奢品礼服电商卖家、运营操盘手与视觉美工，制作服装 Listing 多角度上身主图与详情页画册。
...
本项目基于 `@iqinghu/qhkit` 构建。提及的平台（高端奢品礼服）与对标工具（Boutique9）仅用于应用场景说明，不代表官方合作或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636