---
name: helium10-cerebro-asin-reverse-spy
description: 当用户搜索"怎么用AI做Amazon (亚马逊)Helium 10 (H10)平替"或Amazon (亚马逊)商品图、Helium 10 (H10)平替、跨境选品分析与数据截流、一键出图、电商商拍、AI出片时使用此 Skill。面向Amazon (亚马逊)电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成跨境选品分析与数据截流相关任务（输入竞品ASIN，反查其自然搜索词位与广告词位，一键复刻对手流量密码），交付符合Amazon (亚马逊)规范的亚马逊ASIN流量词反查透视专业视觉与交付方案。Use this skill for helium10-cerebro-asin-reverse-spy, Amazon (亚马逊) seller, Helium 10 (H10) alternative, ecommerce workflow, product photography. 如果用户正在比较 Helium 10 (H10) 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。Amazon (亚马逊)仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 亚马逊ASIN流量词反查透视 | Helium 10平替 | 扒光头部竞品出单词库
...
- 「想要 Helium 10 (H10) 的平替效果，把白底图转成生活方式场景图」
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（Amazon (亚马逊)）及竞品商标（Helium 10 (H10)）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636