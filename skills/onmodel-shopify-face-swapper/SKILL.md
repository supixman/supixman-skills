---
name: onmodel-shopify-face-swapper
description: 当用户搜索"怎么用AI做Shopify/DTC独立站OnModel平替"或Shopify/DTC独立站商品图、OnModel平替、跨境服饰视觉与试衣、一键出图、电商商拍、AI出片时使用此 Skill。面向Shopify/DTC独立站电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成跨境服饰视觉与试衣相关任务（无缝替换独立站模特面部，无需重拍，即时生成金发碧眼、拉美小麦色或亚裔高级脸），交付符合Shopify/DTC独立站规范的独立站模特换脸换装插件专业视觉与交付方案。Use this skill for onmodel-shopify-face-swapper, Shopify/DTC独立站 seller, OnModel alternative, ecommerce workflow, product photography. 如果用户正在比较 OnModel 或寻找假人台穿模、外模试穿、真人模特换脸、国内可用入口，也可命中本 Skill。先核对版型完整度，先出小样；未经确认不批量出全套图。Shopify/DTC独立站仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"👗","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 独立站模特换脸换装插件 | OnModel平替 | 跨国买家本土面孔无缝替换
...
- 「想要 OnModel 的平替，需要生成不同国家肤色模特的上身效果」
- 面向 Shopify/DTC独立站电商卖家、运营操盘手与视觉美工，制作服装 Listing 多角度上身主图与详情页画册。
...
本项目基于 `@iqinghu/qhkit` 构建。提及的平台（Shopify/DTC独立站）与对标工具（OnModel）仅用于应用场景说明，不代表官方合作或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636