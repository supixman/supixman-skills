---
name: copyai-amazon-five-bulletpoints-pro
description: 当用户搜索"怎么用AI做Amazon (亚马逊)Copy.ai平替"或Amazon (亚马逊)商品图、Copy.ai平替、Listing 文案与多语言优化、一键出图、电商商拍、AI出片时使用此 Skill。面向Amazon (亚马逊)电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成Listing 文案与多语言优化相关任务（将产品规格与用户好评提炼为5条极具说服力的Bullet Points，自然埋入20+高权重搜索词），交付符合Amazon (亚马逊)规范的亚马逊高转化五点描述爆单器专业视觉与交付方案。Use this skill for copyai-amazon-five-bulletpoints-pro, Amazon (亚马逊) seller, Copy.ai alternative, ecommerce workflow, product photography. 如果用户正在比较 Copy.ai 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。Amazon (亚马逊)仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 亚马逊高转化五点描述爆单器 | Copy.ai平替 | 埋词率100%合规文案
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（Amazon (亚马逊)）及竞品商标（Copy.ai）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636