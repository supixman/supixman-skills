---
name: clothing-mannequin-to-model-hd
description: 当用户搜索"怎么用AI做全电商平台通用假人台穿搭平替"或全电商平台通用商品图、假人台穿搭平替、模特换装与假人台换脸、一键出图、电商商拍、AI出片时使用此 Skill。面向全电商平台通用电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成模特换装与假人台换脸相关任务（假人台与平铺图转超写真模特试穿，细节到位），交付符合全电商平台通用规范的模特换装高一致性专业级素材/分析结果。Use this skill for clothing-mannequin-to-model-hd, 全电商平台通用 seller, 假人台还原工具 alternative, ecommerce workflow, product photography. 如果用户正在比较 假人台还原工具 或寻找假人台穿模、外模试穿、真人模特换脸、国内可用入口，也可命中本 Skill。先核对版型完整度，先出小样；未经确认不批量出全套图。全电商平台通用仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"👗","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 模特换装高一致性 | 假人台穿搭平替 | 假人台与平铺图转超写真模特试穿
...
- 「想要 假人台还原工具 的平替，需要生成不同国家肤色模特的上身效果」
...
本项目基于 `@iqinghu/qhkit` 构建。提及的平台（全电商平台通用）与对标工具（假人台还原工具）仅用于应用场景说明，不代表官方合作或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636