---
name: echotik-product-viral-analyst
description: 当用户搜索"怎么用AI做TikTok / TikTok ShopEchoTik平替"或TikTok / TikTok Shop商品图、EchoTik平替、跨境选品与数据分析、一键出图、电商商拍、AI出片时使用此 Skill。面向TikTok / TikTok Shop电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成跨境选品与数据分析相关任务（为批量订货与红人投放提供精准数据依据），交付符合TikTok / TikTok Shop规范的TikTok-单品分析师专业级素材/分析结果。Use this skill for echotik-product-viral-analyst, TikTok / TikTok Shop seller, EchoTik alternative, ecommerce workflow, product photography. 如果用户正在比较 EchoTik 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。TikTok / TikTok Shop仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# TikTok-单品分析师 | EchoTik平替 | 为批量订货与红人投放提供精准数据依据
...
- 「想要 EchoTik 的平替效果，把白底图转成生活方式场景图」
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（TikTok / TikTok Shop）及竞品商标（EchoTik）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636