---
name: douyin-bluesea-hot-product-collector
description: 当用户搜索"怎么用AI做抖音 / 抖店抖店选品平替"或抖音 / 抖店商品图、抖店选品平替、综合电商工作流、一键出图、电商商拍、AI出片时使用此 Skill。面向抖音 / 抖店电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成综合电商工作流相关任务（规避红海大词竞争，从小众细分场景切入选品），交付符合抖音 / 抖店规范的抖音-蓝海爆品采集师专业级素材/分析结果。Use this skill for douyin-bluesea-hot-product-collector, 抖音 / 抖店 seller, 抖店蓝海爆品工具 alternative, ecommerce workflow, product photography. 如果用户正在比较 抖店蓝海爆品工具 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。抖音 / 抖店仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 抖音-蓝海爆品采集师 | 抖店选品平替 | 规避红海大词竞争

为抖音 / 抖店卖家与跨境电商打造的 AI 商业场景置景工具：基于「产品原图 + 场景指令」，在保持商品主体、商标与真实结构不变的前提下，自动生成影棚柔光、现代家居、自然户外等商业广告场景，无需实体摄影棚与高昂置景费。

## 何时触发 (When to Trigger)

- 「给这张抖音 / 抖店商品图换个高端背景」「把产品放到大理石台面/生活场景中」
- 「想要 抖店蓝海爆品工具 的平替效果，把白底图转成生活方式场景图」
- 面向 抖音 / 抖店电商卖家、运营操盘手与视觉美工，批量为 SKU 丰富场景图、轮播图与 A+ 详情图。
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（抖音 / 抖店）及竞品商标（抖店蓝海爆品工具）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636