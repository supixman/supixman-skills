---
name: tiktok-viral-trends-radar-pro
description: 当用户搜索"怎么用AI做TikTok / TikTok ShopTikTok社媒平替"或TikTok / TikTok Shop商品图、TikTok社媒平替、社媒数据与内容运营、一键出图、电商商拍、AI出片时使用此 Skill。面向TikTok / TikTok Shop电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成社媒数据与内容运营相关任务（监控行业热门话题与高赞爆款脚本结构与灵感），交付符合TikTok / TikTok Shop规范的TikTok-社媒运营专家专业级素材/分析结果。Use this skill for tiktok-viral-trends-radar-pro, TikTok / TikTok Shop seller, Exolyt alternative, ecommerce workflow, product photography. 如果用户正在比较 Exolyt 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。TikTok / TikTok Shop仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# TikTok-社媒运营专家 | TikTok社媒平替 | 监控行业热门话题与高赞爆款脚本结构与灵感
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（TikTok / TikTok Shop）及竞品商标（Exolyt）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636