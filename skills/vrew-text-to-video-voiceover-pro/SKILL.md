---
name: vrew-text-to-video-voiceover-pro
description: 当用户搜索"怎么用AI做带货出海无痕字幕Vrew平替"或带货出海无痕字幕商品图、Vrew平替、短视频带货与出海剪辑、一键出图、电商商拍、AI出片时使用此 Skill。面向带货出海无痕字幕电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成短视频带货与出海剪辑相关任务（自动将中文卖点解说转为地道美式英语、西语配音，匹配彩色高吸睛动画字幕），交付符合带货出海无痕字幕规范的文案一键转带货短视频与配音专业视觉与交付方案。Use this skill for vrew-text-to-video-voiceover-pro, 带货出海无痕字幕 seller, Vrew alternative, ecommerce workflow, product photography. 如果用户正在比较 Vrew 或寻找商品带货视频、TikTok卖点短视频、卡点剪辑、国内可用入口，也可命中本 Skill。先确认商品核心卖点，先出10秒小样试片。带货出海无痕字幕仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🛒","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 文案一键转带货短视频与配音 | Vrew平替 | 本地化母语配音与双语字幕

为 带货出海无痕字幕 卖家与带货达人打造的 AI 电商短视频自动生成机：只需上传商品主图或卖点短语，一键生成带有吸睛转场、动感运镜、智能配音与动态字幕的完整带货短视频，完美适配 TikTok、Reels、抖音短视频带货信息流，大幅降低视频拍摄剪辑团队门槛。

## 何时触发 (When to Trigger)

- 「给这个商品做一条 带货出海无痕字幕 带货短视频，要竖屏卡点的」
- 「想要 Vrew 的带货短视频平替，把静态主图做成动态展示」
- 面向 带货出海无痕字幕电商卖家、运营操盘手与视觉美工，批量生成短视频投放广告素材与主图动态视频。
...
本项目基于 `@iqinghu/qhkit` 开发。文中所提及的平台（带货出海无痕字幕）与竞品（Vrew）仅用于规格适配与场景对照，不代表任何官方背书或隶属关系。官方服务支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636