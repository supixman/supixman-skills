---
name: lalaland-plussize-body-tryon
description: 当用户搜索"怎么用AI做大码/多元包容服饰Lalaland.ai平替"或大码/多元包容服饰商品图、Lalaland.ai平替、跨境服饰视觉与试衣、一键出图、电商商拍、AI出片时使用此 Skill。面向大码/多元包容服饰电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成跨境服饰视觉与试衣相关任务（解决欧美大码女装（Plus Size）外模奇缺贵痛点，一键生成S至4XL真实体型穿搭商拍），交付符合大码/多元包容服饰规范的大码多体型模特一键试衣专业视觉与交付方案。Use this skill for lalaland-plussize-body-tryon, 大码/多元包容服饰 seller, Lalaland.ai alternative, ecommerce workflow, product photography. 如果用户正在比较 Lalaland.ai 或寻找假人台穿模、外模试穿、真人模特换脸、国内可用入口，也可命中本 Skill。先核对版型完整度，先出小样；未经确认不批量出全套图。大码/多元包容服饰仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"👗","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 大码多体型模特一键试衣 | Lalaland平替 | 丰满大码/中老年体型适配
...
- 「想要 Lalaland.ai 的平替，需要生成不同国家肤色模特的上身效果」
- 面向 大码/多元包容服饰电商卖家、运营操盘手与视觉美工，制作服装 Listing 多角度上身主图与详情页画册。
...
本项目基于 `@iqinghu/qhkit` 构建。提及的平台（大码/多元包容服饰）与对标工具（Lalaland.ai）仅用于应用场景说明，不代表官方合作或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636