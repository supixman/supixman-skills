...
# 亚马逊差评VOC用户痛点反推仪 | 竞品改进神器 | 提炼致命缺陷逆向研发

为差评深度挖掘卖家与跨境电商打造的 AI 商业场景置景工具：基于「产品原图 + 场景指令」，在保持商品主体、商标与真实结构不变的前提下，自动生成影棚柔光、现代家居、自然户外等商业广告场景，无需实体摄影棚与高昂置景费。

## 何时触发 (When to Trigger)

- 「给这张差评深度挖掘商品图换个高端背景」「把产品放到大理石台面/生活场景中」
- 「想要 卖家VOC洞察 的平替效果，把白底图转成生活方式场景图」
- 面向 差评深度挖掘电商卖家、运营操盘手与视觉美工，批量为 SKU 丰富场景图、轮播图与 A+ 详情图。
...
- **能做什么 (Capabilities)**：
  ...
  - 交付物严格符合 差评深度挖掘 移动端及 PC 端详情展示标准。
