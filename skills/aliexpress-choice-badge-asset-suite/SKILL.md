---
name: aliexpress-choice-badge-asset-suite
description: 当用户搜索"怎么用AI做速卖通 Choice 专精速卖通大卖视觉平替"或速卖通 Choice 专精商品图、速卖通大卖视觉平替、出海全托管与半托管视觉、一键出图、电商商拍、AI出片时使用此 Skill。面向速卖通 Choice 专精电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成出海全托管与半托管视觉相关任务（生成带有X-Day Delivery极速达、EU Plug认证等增强买家决策信心的信任标识套图），交付符合速卖通 Choice 专精规范的速卖通Choice专区极速上架主图包专业视觉与交付方案。Use this skill for aliexpress-choice-badge-asset-suite, 速卖通 Choice 专精 seller, 速卖通大卖视觉 alternative, ecommerce workflow, product photography. 如果用户正在比较 速卖通大卖视觉 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。速卖通 Choice 专精仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# 速卖通Choice专区极速上架主图包 | AliExpress标配 | 欧美欧规插头与极速到货标识

为速卖通 Choice 专精卖家与跨境电商打造的 AI 商业场景置景工具：基于「产品原图 + 场景指令」，在保持商品主体、商标与真实结构不变的前提下，自动生成影棚柔光、现代家居、自然户外等商业广告场景，无需实体摄影棚与高昂置景费。

## 何时触发 (When to Trigger)

- 「给这张速卖通 Choice 专精商品图换个高端背景」「把产品放到大理石台面/生活场景中」
- 「想要 速卖通大卖视觉 的平替效果，把白底图转成生活方式场景图」
- 面向 速卖通 Choice 专精电商卖家、运营操盘手与视觉美工，批量为 SKU 丰富场景图、轮播图与 A+ 详情图。
...
- **能做什么 (Capabilities)**：
  ...
  - 交付物严格符合 速卖通 Choice 专精 移动端及 PC 端详情展示标准。
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（速卖通 Choice 专精）及竞品商标（速卖通大卖视觉）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636