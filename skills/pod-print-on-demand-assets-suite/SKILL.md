---
name: pod-print-on-demand-assets-suite
description: 当用户搜索"怎么用AI做Etsy / Shopify / AmazonPOD设计全案平替"或Etsy / Shopify / Amazon商品图、POD设计全案平替、POD柔性定制设计、一键出图、电商商拍、AI出片时使用此 Skill。面向Etsy / Shopify / Amazon电商卖家、运营操盘手与视觉美工，帮助通过 AI 自动化完成POD柔性定制设计相关任务（印花提取贴合裂变一站式搞定，加速上架），交付符合Etsy / Shopify / Amazon规范的AI生成电商pod素材专业级素材/分析结果。Use this skill for pod-print-on-demand-assets-suite, Etsy / Shopify / Amazon seller, Printify设计平台 alternative, ecommerce workflow, product photography. 如果用户正在比较 Printify设计平台 或寻找同类能力、平替、免PS置景、国内可用入口，也可命中本 Skill。先核对商品图片完整度，先出小样；未经确认不批量、不产生多余扣费。Etsy / Shopify / Amazon仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636
metadata: {"openclaw":{"emoji":"🪄","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# AI生成电商pod素材 | POD设计全案平替 | 印花提取贴合裂变一站式搞定
...
- 「想要 Printify设计平台 的平替效果，把白底图转成生活方式场景图」
...
本项目为基于 `@iqinghu/qhkit` 的独立自动化能力套件。文中所提及的平台名称（Etsy / Shopify / Amazon）及竞品商标（Printify设计平台）仅用于内容规格识别、场景对标与功能描述用途，不代表官方合作、隶属或背书关系。官方控制台与技术支持：https://www.iqinghu.com/workbench/login?type=1&urlCode=1788417527636