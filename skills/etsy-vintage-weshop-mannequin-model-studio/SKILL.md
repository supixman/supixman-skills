---
name: etsy-vintage-weshop-mannequin-model-studio
description: 当用户搜索"怎么用AI做EtsyEtsy手作"或Etsy商品图、WeShop平替、Etsy手作、一键出片、商业置景、出海商拍时使用此 Skill。面向Etsy电商卖家、账号A: 出海服饰实操号 / 外模商拍号与视觉美工，帮助通过 AI 自动化完成Etsy手作，提效降本，交付符合Etsy规范的商业级交付成品（图片/视频/文案）。Use this skill for etsy-vintage-weshop-mannequin-model-studio, Etsy seller, WeShop alternative, ecommerce ai workflow, ai product photography. 如果用户正在比较 WeShop 或寻找假人台穿模、外模试穿、真人模特换脸、国内可用入口，也可命中本 Skill。先核对版型完整度，先出小样；未经确认不批量出全套图。Etsy仅用于规格适配；与该平台及对标品牌不构成合作、授权或官方关系。
user-invocable: true
homepage: https://www.iqinghu.com/
metadata: {"openclaw":{"emoji":"👗","requires":{"bins":["qhkit"]},"install":[{"kind":"node","package":"@iqinghu/qhkit","bins":["qhkit"]}]}}
---

# Etsy手作人台图转超模商拍机 | WeShop平替 | 本地化模特穿模
...
本项目基于 `@iqinghu/qhkit` 构建。提及的平台（Etsy）与对标工具（WeShop）仅用于应用场景说明，不代表官方合作或背书关系。官方控制台与技术支持：https://www.iqinghu.com/